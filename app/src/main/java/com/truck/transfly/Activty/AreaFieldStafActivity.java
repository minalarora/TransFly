...
public class AreaFieldStafActivity extends AppCompatActivity {
            ...
            public void onClick(View v) {
                ...
                if (activity.registerCategory.getSelectedItem().toString().equals("pan")) {
                    ...
                    if(!TextUtils.isEmpty(activity.enterTdsNumber.getText().toString())){
                        ...
                        uploadMultipartSingle(activity.enterTdsNumber.getText().toString(),"pan","panimage");
                    ...
                    if(!TextUtils.isEmpty(activity.enterTdsNumber.getText().toString())){
                        ...
                        uploadMultipartSingle(activity.enterTdsNumber.getText().toString(),"aadhaar","aadhaarimage");
                    ...
                    if(TextUtils.isEmpty(activity.bankName.getText().toString())){
                        ...
                        Toast.makeText(AreaFieldStafActivity.this, "Enter bank Name", Toast.LENGTH_SHORT).show();

                    } else if(TextUtils.isEmpty(activity.bankNumber.getText().toString())){

                        Toast.makeText(AreaFieldStafActivity.this, "Enter Bank Number", Toast.LENGTH_SHORT).show();

                    } else if(TextUtils.isEmpty(activity.bankIfc.getText().toString())){

                        Toast.makeText(AreaFieldStafActivity.this, "Enter Bank IFSC", Toast.LENGTH_SHORT).show();
    ...
    private void openStorage() {
        ...
        Matisse.from(AreaFieldStafActivity.this)
    ...
    private void uploadBankMultipart() {
        ...
        try {
            multipartUploadRequest = new MultipartUploadRequest(this, EndApi.AREA_FIELD_KYC)
                    .setNotificationConfig(new UploadNotificationConfig())
                    .setMaxRetries(5)
                    .addHeader("Authorization", PreferenceUtil.getData(AreaFieldStafActivity.this,"token"))
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            ...
            if (requestCode == REQUEST_CODE_CHOOSE && data != null) {
                ...
                Glide.with(AreaFieldStafActivity.this).load(storageList.get(0)).skipMemoryCache(true).diskCacheStrategy(DiskCacheStrategy.NONE).into(activity.chooseImageView);
