...
import com.truck.transfly.databinding.ActivityUpdateRate2Binding;
...
public class UpdateRate2Activity extends AppCompatActivity {

    private List<String> stringList = new ArrayList<>();
    private ActivityUpdateRate2Binding activity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activity = DataBindingUtil.setContentView(this, R.layout.activity_update_rate2);
        ...
        if (getIntent() != null) {
            ...
            if (!vehicleOwner) {
                ...
                activity.toolbarText.setText("Update Rate");
        ...
        findViewById(R.id.pullToRefresh_button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                getAllVehicles(PreferenceUtil.getData(UpdateRate2Activity.this, "token"));
...
//                    sendDataOnServer(responseVehicle.getActive(), responseVehicle.getStatus());
                ...
                if(TextUtils.isEmpty(activity.updateRate.getText().toString()))
                {
                    Toast.makeText(UpdateRate2Activity.this, "Please Enter New Rate", Toast.LENGTH_SHORT).show();
                }
                else if (responseVehicleOwner.getStatus() != 2) {

                    Toast.makeText(UpdateRate2Activity.this, "Complete Your KYC First!", Toast.LENGTH_SHORT).show();

                }
                else
                {
                    updateRate(PreferenceUtil.getData(UpdateRate2Activity.this, "token"),activity.updateRate.getText().toString());
                }
    ...
    private void initSmallIconAdapter() {
        ...
        GridLayoutManager linearLayoutManager = new GridLayoutManager(UpdateRate2Activity.this, 1, LinearLayoutManager.HORIZONTAL, false);
        recyclerView.setLayoutManager(linearLayoutManager);
        smallIconsAdapter = new SmallIconsAdapter(UpdateRate2Activity.this, vehicleList);
        ...
        smallIconsAdapter.setOnClickListener(new SmallIconsAdapter.onClickListener() {
            ...
            public void onClick(ResponseVehicle responseVehicle) {
                ...
                UpdateRate2Activity.this.responseVehicle = responseVehicle;
    ...
    private void sendDataOnServer(Boolean active, int status) {
        ...
        else if(activity.noVehicleFound.getVisibility()==View.VISIBLE)
        {
            ...
            createBooking(PreferenceUtil.getData(UpdateRate2Activity.this, "token"), requestBooking);
    ...
    private void createBooking(String token, RequestBooking booking) {
        ...
        api.createBooking(token, booking).enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                if (response.code() == 200) {
                    Toast.makeText(UpdateRate2Activity.this, "Booking Created Successfully", Toast.LENGTH_SHORT).show();

                    Intent intent = new Intent(UpdateRate2Activity.this, HomeActivity.class);
                    ...
                    Toast.makeText(UpdateRate2Activity.this, "Something Went Wrong! Try Again", Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                ...
                Toast.makeText(UpdateRate2Activity.this, "No Internet Connection", Toast.LENGTH_SHORT).show();
    ...
    private void updateRate(String token, String r)
    {
        parent_of_loading.setVisibility(View.VISIBLE);

        TransporterRequest t= new TransporterRequest();
        t.setLoadingname(loading);
        t.setMineid(mineid);
        t.setNewrate(Integer.parseInt(r));
        t.setOldrate(rate);
        t.setMinename(minename);
        api.requestTransporter(token,t).enqueue(new Callback<ResponseBody>() {
            @Override
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                parent_of_loading.setVisibility(View.GONE);
                if(response.code() == 200)
                {
                    Toast.makeText(UpdateRate2Activity.this, "Request for changing rate has been created successfully", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(UpdateRate2Activity.this, TransporterActivity.class);
                    intent.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP); //todo flAGS SETS IN FUTURE
                    startActivity(intent);
    ...
    public void gotoAdd(View view) {
        Intent i =new Intent(UpdateRate2Activity.this,AddVehicleActivity.class);
        startActivity(i);
