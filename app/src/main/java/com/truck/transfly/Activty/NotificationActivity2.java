...
public class NotificationActivity2 extends AppCompatActivity {
    ...
    private List<ResponseNotification> responseNotificationList = new ArrayList<ResponseNotification>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.pullToRefresh_button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                getNotification(PreferenceUtil.getData(NotificationActivity2.this, "token"));
    ...
    private void initNotifications() {
        ...
        LinearLayoutManager gridLayoutManage = new LinearLayoutManager(NotificationActivity2.this, LinearLayoutManager.VERTICAL, false);
        notificationAdapter = new NotificationAdapter(NotificationActivity2.this, responseNotificationList);
    ...
    private void getNotification(String token) {
        ...
        api.getNotifications2(token).enqueue(new Callback<ResponseBody>() {
            @Override
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                if (response.code() == 200) {
                    ...
                    try {
                        //responseNotificationList = new ArrayList<>();
                    ...
                    {
                        Toast.makeText(NotificationActivity2.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
