...
public class RemoveVehcileDialog extends DialogFragment {

    public RemoveVehcileDialog() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View inflate = inflater.inflate(R.layout.fragment_remove_vehcile_dialog, container, false);
