...
public class SpinnerMinesAdapter extends ArrayAdapter<ResponseMine> {

    private List<ResponseMine> items;
    private Activity activity;

    public SpinnerMinesAdapter(Activity activity, List<ResponseMine> items) {
    ...
    @Override
    public ResponseMine getItem(int position) {
